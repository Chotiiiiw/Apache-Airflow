...
def branch_dag():
    ...
    def decider_task(**kwargs):
        ...
        if weekend_flag == 'true':
            return 'no_load_task' #return function name, task name 
        else: 
            return 'load_task'
    ...
    extract >> [transform_api, transfrom_db, transform_s3] >> decider_task() >> [load, no_load]
